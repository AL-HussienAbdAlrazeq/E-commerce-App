    ...
    bgcolor="#F4F7FA">
      <tbody>
        <tr>
          ...
          In order to start using your E-Shop account, you need to confirm your email address.
        </span>
          ...
          <a href="http://localhost:3000/api/auth/verify/${token}" style="display:block; padding:15px 25px; background-color:#0087D1; color:#ffffff; border-radius:3px; text-decoration:none;"> Confirm Email </a>
        </span>
